...
class QuebradaDetalleScreen extends StatelessWidget {
  const QuebradaDetalleScreen({ Key? key }) : super(key: key);
      ...
      child: Column(
        children: [
          ...
          const Padding(
            ...
            child: Text(lorem_ipsum,style: TextStyle(fontSize: 15)),
          ),
          const SizedBox(height: 10),
          Row(
